...
var width_PERCENT__45531 = ((new_window_width - x) / new_window_width);
if((width_PERCENT__45531 <= 0.9)){
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","panel-width%","day8.re-frame-10x.panels.settings.events/panel-width%",-569115915),width_PERCENT__45531], null));
} else {
}
...
var trace = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45502_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(trace_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__45502_SHARP_));
...
var view = (function (p1__45513_SHARP_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),p1__45513_SHARP_,new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__45513_SHARP_)], null);
});
var alias = (function (p__45515){
var vec__45516 = p__45515;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45516,(0),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,keep_vals,new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"debug?","debug?",-1831756173),day8.re_frame_10x.debug_QMARK_,new cljs.core.Keyword(null,"retained-epochs","retained-epochs",1350238734),day8.re_frame_10x.history_size,new cljs.core.Keyword(null,"ignored-events","ignored-events",1738756589),(function (){var G__45520 = day8.re_frame_10x.ignored_events;
var G__45520__$1 = (((G__45520 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__45520) : read.call(null, G__45520)));
if((G__45520__$1 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__45520__$1);
}
})(),new cljs.core.Keyword(null,"filtered-view-trace","filtered-view-trace",-901876599),(function (){var G__45522 = day8.re_frame_10x.hidden_namespaces;
var G__45522__$1 = (((G__45522 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__45522) : read.call(null, G__45522)));
var G__45522__$2 = (((G__45522__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(view,G__45522__$1));
if((G__45522__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__45522__$2);
}
})(),new cljs.core.Keyword(null,"app-db-follows-events?","app-db-follows-events?",-1566738462),day8.re_frame_10x.time_travel_QMARK_,new cljs.core.Keyword(null,"low-level-trace","low-level-trace",638447092),(function (){var G__45524 = day8.re_frame_10x.ignored_libs;
var G__45524__$1 = (((G__45524 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__45524) : read.call(null, G__45524)));
if((G__45524__$1 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.pred_map(G__45524__$1,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),null,new cljs.core.Keyword(null,"reagent","reagent",2131627322),null], null), null));
}
})(),new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821),(function (){var G__45525 = day8.re_frame_10x.ns_aliases;
var G__45525__$1 = (((G__45525 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__45525) : read.call(null, G__45525)));
var G__45525__$2 = (((G__45525__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(alias,G__45525__$1));
if((G__45525__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__45525__$2);
}
})(),new cljs.core.Keyword(null,"trace-when","trace-when",-1902271347),(function (){var G__45527 = day8.re_frame_10x.trace_when;
var G__45527__$1 = (((G__45527 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__45527) : read.call(null, G__45527)));
if((G__45527__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__45527__$1);
}
})()], null));
})();
