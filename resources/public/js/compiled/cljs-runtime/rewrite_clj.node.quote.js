...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k22860,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k22860,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__22944){
var vec__22951 = p__22944;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22951,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22951,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22859){
var self__ = this;
var G__22859__$1 = this;
return (new cljs.core.RecordIter((0),G__22859__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22863,other22864){
var self__ = this;
var this22863__$1 = this;
return (((!((other22864 == null)))) && ((((this22863__$1.constructor === other22864.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22863__$1.tag,other22864.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22863__$1.prefix,other22864.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22863__$1.sym,other22864.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22863__$1.children,other22864.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22863__$1.__extmap,other22864.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k22860){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k22860);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__22859){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__23088 = cljs.core.keyword_identical_QMARK_;
var expr__23089 = k__5309__auto__;
if(cljs.core.truth_((pred__23088.cljs$core$IFn$_invoke$arity$2 ? pred__23088.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23089) : pred__23088.call(null, new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23089)))){
return (new rewrite_clj.node.quote.QuoteNode(G__22859,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23088.cljs$core$IFn$_invoke$arity$2 ? pred__23088.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__23089) : pred__23088.call(null, new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__23089)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__22859,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23088.cljs$core$IFn$_invoke$arity$2 ? pred__23088.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__23089) : pred__23088.call(null, new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__23089)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__22859,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23088.cljs$core$IFn$_invoke$arity$2 ? pred__23088.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__23089) : pred__23088.call(null, new cljs.core.Keyword(null,"children","children",-940561982),expr__23089)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__22859,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__22859),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__22859){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__22859,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__22876){
var extmap__5342__auto__ = (function (){var G__23150 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__22876,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__22876)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23150);
} else {
return G__23150;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__22876),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__22876),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__22876),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__22876),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
var G__23262 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23262;
continue;
}
break;
...
var G__23263 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23263;
continue;
}
break;
...
var G__23266 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23266;
continue;
}
break;
...
var G__23272 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23272;
continue;
}
break;
