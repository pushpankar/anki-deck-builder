...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f,(function (p1__29280_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__29280_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),true);
}));
}));
...
var ns__$1 = (function (){var or__5002__auto__ = ns;
...
return sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,(function (){var G__29323 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"ns","ns",441598760),ns__$1,new cljs.core.Keyword(null,"macro","macro",-867863404),true,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599),true], null);
if(cljs.core.truth_((function (){var and__5000__auto__ = (!(sci.impl.copy_vars.elide_vars));
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__29323,extra_meta], 0));
} else {
return G__29323;
}
})(),ctx_QMARK_);
...
var ctx_QMARK___$1 = (function (){var or__5002__auto__ = ctx_QMARK_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return ns === true;
...
var ns__$1 = ((ns === true)?sci.impl.utils.clojure_core_ns:(function (){var or__5002__auto__ = ns;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return sci.impl.utils.clojure_core_ns;
...
return sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,(function (){var G__29562 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),ns__$1,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599),true], null);
if(cljs.core.truth_((function (){var and__5000__auto__ = (!(sci.impl.copy_vars.elide_vars));
if(and__5000__auto__){
return extra_meta;
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__29562,extra_meta], 0));
} else {
return G__29562;
}
})(),ctx_QMARK___$1);
