...
var G__27254 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__27255 = n;
var G__27256 = cljs.core.nnext(bs);
var G__27257 = true;
ret = G__27254;
n = G__27255;
bs = G__27256;
seen_rest_QMARK_ = G__27257;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__27095_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5002__auto__ = mkns;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return cljs.core.namespace(p1__27095_SHARP_);
}
})(),cljs.core.name(p1__27095_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__27096_SHARP_){
...
return cljs.core.namespace(p1__27096_SHARP_);
}
})(),cljs.core.name(p1__27096_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__27097_SHARP_,p2__27098_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__27097_SHARP_,p2__27098_SHARP_,(function (){var fexpr__27208 = cljs.core.val(entry);
return (fexpr__27208.cljs$core$IFn$_invoke$arity$1 ? fexpr__27208.cljs$core$IFn$_invoke$arity$1(p2__27098_SHARP_) : fexpr__27208.call(null, p2__27098_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__27209 = cljs.core.key(entry);
return (fexpr__27209.cljs$core$IFn$_invoke$arity$1 ? fexpr__27209.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__27209.call(null, bes));
})());
...
var G__27302 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__27303 = cljs.core.next(bes);
ret = G__27302;
bes = G__27303;
continue;
} else {
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27102_SHARP_){
return (cljs.core.first(p1__27102_SHARP_) instanceof cljs.core.Keyword);
}),bents));
