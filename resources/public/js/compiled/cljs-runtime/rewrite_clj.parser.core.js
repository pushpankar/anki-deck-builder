...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__23934 = cljs.core.get_global_hierarchy;
return (fexpr__23934.cljs$core$IFn$_invoke$arity$0 ? fexpr__23934.cljs$core$IFn$_invoke$arity$0() : fexpr__23934.call(null, ));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__23940_SHARP_){
var _STAR_delimiter_STAR__orig_val__23943 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__23944 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__23944);

try{return rewrite_clj.parser.core.parse_next(p1__23940_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__23943);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5732__auto__ = [];
var len__5726__auto___23990 = arguments.length;
var i__5727__auto___23991 = (0);
while(true){
if((i__5727__auto___23991 < len__5726__auto___23990)){
args__5732__auto__.push((arguments[i__5727__auto___23991]));

var G__23992 = (i__5727__auto___23991 + (1));
i__5727__auto___23991 = G__23992;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__23953){
var vec__23954 = p__23953;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23954,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq23948){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23949,G__23950,G__23951,seq23948__$3);
}));
...
var G__23969 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__23969)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__23969)){
...
return cljs.core.cons((function (){var G__23974 = rewrite_clj.reader.peek(reader);
switch (G__23974) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__23969)){
