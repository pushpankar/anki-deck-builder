...
var o__11955__auto__ = f;
return (o__11955__auto__["toString"]).call(o__11955__auto__);
} else {
return "";
}
}catch (e12215){var _ = e12215;
return "";
}});
...
try{var o__11955__auto___13024 = t;
(o__11955__auto___13024["cljs$lang$ctorPrWriter"]).call(o__11955__auto___13024,t,writer);
}catch (e12232){var __13027 = e12232;
}
...
var char_code = (function (){var o__11955__auto__ = (new String(char$));
return (o__11955__auto__["charCodeAt"]).call(o__11955__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11955__auto__ = String;
return (o__11955__auto__["fromCharCode"]).call(o__11955__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12274 = num_code;
switch (G__12274) {
case (1):
return (185);
...
var o__11955__auto__ = String;
return (o__11955__auto__["fromCharCode"]).call(o__11955__auto__,superscript_code);
});
/**
...
}catch (e12324){var _e__11991__auto__ = e12324;
return false;
}})())){
...
var vec__12329 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12329,(0),null);
...
var len__5726__auto___13098 = arguments.length;
var i__5727__auto___13099 = (0);
while(true){
if((i__5727__auto___13099 < len__5726__auto___13098)){
args__5732__auto__.push((arguments[i__5727__auto___13099]));

var G__13101 = (i__5727__auto___13099 + (1));
i__5727__auto___13099 = G__13101;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12398){
var vec__12399 = p__12398;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12399,(0),null);
...
var G__13111 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13112 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13111;
remaining_tokens = G__13112;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12383){
var G__12385 = cljs.core.first(seq12383);
var seq12383__$1 = cljs.core.next(seq12383);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12385,seq12383__$1);
}));
...
var vec__12430 = cljs.core.split_with((function (p1__12425_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12425_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12430,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12430,(1),null);
...
var vec__12468 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12468,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12468,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13119 = cljs.core.rest(remaining_tokens);
var G__13120 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13119;
name_tokens = G__13120;
continue;
} else {
...
var vec__12499 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12499,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12499,(1),null);
var vec__12503 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12503,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12503,(1),null);
var vec__12506 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12506,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12506,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12506,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12506,(3),null);
...
var vec__12545 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12545,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12545,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12545,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12545,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12545,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12545,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12558 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12558,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12558,(1),null);
var vec__12562 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12562,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12608 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12608) : devtools.munging.parse_fn_info_deep.call(null, G__12608));
})()));
}
} else {
return fn_info;
...
var G__13151 = (arity + (1));
var G__13152 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12691){
var vec__12694 = p__12691;
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12748_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12748_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12749_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12749_SHARP_);
}),sorted_infos);
...
var G__13172 = (i__5727__auto___13169 + (1));
i__5727__auto___13169 = G__13172;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12768){
var G__12769 = cljs.core.first(seq12768);
var seq12768__$1 = cljs.core.next(seq12768);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12769,seq12768__$1);
}));
...
var map__12902 = options;
var map__12902__$1 = cljs.core.__destructure_map(map__12902);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12902__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12902__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12902__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12902__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12903 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12903,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12903,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12903,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12903,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12903,(4),null);
...
var o__11955__auto__ = f;
return (o__11955__auto__["getBasis"]).call(o__11955__auto__);
});
/**
...
}catch (e12922){var _e__11991__auto__ = e12922;
...
var G__13263 = (obj[cljs.core.first(path)]);
var G__13264 = cljs.core.rest(path);
obj = G__13263;
path = G__13264;
continue;
} else {
...
var _STAR_ = (function (accum,p__12947){
var vec__12948 = p__12947;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12948,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12948,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12971){
var vec__12973 = p__12971;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12973,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12973,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12973,(2),null);
...
var post_process = (function (p__12989){
var vec__12991 = p__12989;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12991,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12991,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12983_SHARP_){
return (obj[cljs.core.first(p1__12983_SHARP_)]);
}),sorted_matches);
