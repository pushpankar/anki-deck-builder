...
var ensure_set_22047 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(m)),(ensure_set_22047.cljs$core$IFn$_invoke$arity$1 ? ensure_set_22047.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_22047.call(null, ks)));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_22047.cljs$core$IFn$_invoke$arity$1 ? ensure_set_22047.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_22047.call(null, ks)));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_22047.cljs$core$IFn$_invoke$arity$1 ? ensure_set_22047.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_22047.call(null, ks)));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_((function (p1__22035_SHARP_){
return (!((cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__22035_SHARP_) == null)));
}),ks);
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__22036_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("clojure.core",p1__22036_SHARP_);
}),names)),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__22037_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("cljs.core",p1__22037_SHARP_);
}),names));
})();
...
var G__22041 = (new cljs.core.Delay((function (){
...
return (error_fn.cljs$core$IFn$_invoke$arity$1 ? error_fn.cljs$core$IFn$_invoke$arity$1(G__22041) : error_fn.call(null, G__22041));
} else {
return null;
}
});
