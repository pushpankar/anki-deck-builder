...
rewrite_clj.node.keyword.keyword_sexpr = (function rewrite_clj$node$keyword$keyword_sexpr(kw,kw_auto_resolved_QMARK_,map_qualifier,p__21830){
var map__21833 = p__21830;
var map__21833__$1 = cljs.core.__destructure_map(map__21833);
var auto_resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21833__$1,new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983));
...
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var G__21840 = (cljs.core.truth_(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(q))?(function (){var G__21847 = (function (){var or__5002__auto__ = (function (){var G__21850 = new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q);
if((G__21850 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__21850);
}
})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
var fexpr__21846 = (function (){var or__5002__auto__ = auto_resolve;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
return (fexpr__21846.cljs$core$IFn$_invoke$arity$1 ? fexpr__21846.cljs$core$IFn$_invoke$arity$1(G__21847) : fexpr__21846.call(null, G__21847));
})():new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q));
if((G__21840 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21840);
}
})(),cljs.core.name(kw));
});
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k21869,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21869,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__21909){
var vec__21915 = p__21909;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21915,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21915,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21868){
var self__ = this;
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21870,other21871){
var self__ = this;
var this21870__$1 = this;
return (((!((other21871 == null)))) && ((((this21870__$1.constructor === other21871.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21870__$1.k,other21871.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21870__$1.auto_resolved_QMARK_,other21871.auto_resolved_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21870__$1.map_qualifier,other21871.map_qualifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21870__$1.__extmap,other21871.__extmap)))))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k21869){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k21869);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__21868){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__22110 = cljs.core.keyword_identical_QMARK_;
var expr__22111 = k__5309__auto__;
if(cljs.core.truth_((pred__22110.cljs$core$IFn$_invoke$arity$2 ? pred__22110.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__22111) : pred__22110.call(null, new cljs.core.Keyword(null,"k","k",-2146297393),expr__22111)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__21868,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__22110.cljs$core$IFn$_invoke$arity$2 ? pred__22110.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__22111) : pred__22110.call(null, new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__22111)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__21868,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__22110.cljs$core$IFn$_invoke$arity$2 ? pred__22110.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__22111) : pred__22110.call(null, new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__22111)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,G__21868,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__21868),null));
}
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__21868){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,G__21868,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__21878){
var extmap__5342__auto__ = (function (){var G__22233 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21878,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720)], 0));
...
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__21878),new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(G__21878),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720).cljs$core$IFn$_invoke$arity$1(G__21878),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
