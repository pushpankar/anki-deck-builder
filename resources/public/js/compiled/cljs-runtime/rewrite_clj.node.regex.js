...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k22854,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k22854,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__22934){
var vec__22936 = p__22934;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22936,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22936,(1),null);
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22853){
var self__ = this;
var G__22853__$1 = this;
return (new cljs.core.RecordIter((0),G__22853__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22855,other22856){
var self__ = this;
var this22855__$1 = this;
return (((!((other22856 == null)))) && ((((this22855__$1.constructor === other22856.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22855__$1.pattern,other22856.pattern)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22855__$1.__extmap,other22856.__extmap)))))));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k22854){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k22854);

}
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__22853){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__23040 = cljs.core.keyword_identical_QMARK_;
var expr__23041 = k__5309__auto__;
if(cljs.core.truth_((pred__23040.cljs$core$IFn$_invoke$arity$2 ? pred__23040.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__23041) : pred__23040.call(null, new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__23041)))){
return (new rewrite_clj.node.regex.RegexNode(G__22853,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__22853),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__22853){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__22853,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__22875){
var extmap__5342__auto__ = (function (){var G__23066 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__22875,new cljs.core.Keyword(null,"pattern","pattern",242135423));
if(cljs.core.record_QMARK_(G__22875)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23066);
} else {
return G__23066;
}
})();
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__22875),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
