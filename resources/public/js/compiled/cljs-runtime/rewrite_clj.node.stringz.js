...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k22888,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k22888,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__22956){
var vec__22962 = p__22956;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(1),null);
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22887){
var self__ = this;
var G__22887__$1 = this;
return (new cljs.core.RecordIter((0),G__22887__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"lines","lines",-700165781)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22889,other22890){
var self__ = this;
var this22889__$1 = this;
return (((!((other22890 == null)))) && ((((this22889__$1.constructor === other22890.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22889__$1.lines,other22890.lines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22889__$1.__extmap,other22890.__extmap)))))));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k22888){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k22888);

}
}));

(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__22887){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__23037 = cljs.core.keyword_identical_QMARK_;
var expr__23038 = k__5309__auto__;
if(cljs.core.truth_((pred__23037.cljs$core$IFn$_invoke$arity$2 ? pred__23037.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"lines","lines",-700165781),expr__23038) : pred__23037.call(null, new cljs.core.Keyword(null,"lines","lines",-700165781),expr__23038)))){
return (new rewrite_clj.node.stringz.StringNode(G__22887,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.stringz.StringNode(self__.lines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__22887),null));
}
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__22887){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.stringz.StringNode(self__.lines,G__22887,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.stringz.map__GT_StringNode = (function rewrite_clj$node$stringz$map__GT_StringNode(G__22895){
var extmap__5342__auto__ = (function (){var G__23064 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__22895,new cljs.core.Keyword(null,"lines","lines",-700165781));
if(cljs.core.record_QMARK_(G__22895)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23064);
} else {
return G__23064;
}
})();
return (new rewrite_clj.node.stringz.StringNode(new cljs.core.Keyword(null,"lines","lines",-700165781).cljs$core$IFn$_invoke$arity$1(G__22895),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
