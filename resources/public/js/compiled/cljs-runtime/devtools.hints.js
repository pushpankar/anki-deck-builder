...
var map__13122 = top_item;
var map__13122__$1 = cljs.core.__destructure_map(map__13122);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13122__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13122__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13122__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e13121){var _e = e13121;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___13153 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___13153)){
var seen_errors_13154 = temp__5802__auto___13153;
if(cljs.core.truth_(seen_errors_13154.has(self))){
} else {
seen_errors_13154.add(self);

var temp__5804__auto___13155 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___13155)){
var sense_13156 = temp__5804__auto___13155;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13156)].join(''));
} else {
}
}
} else {
