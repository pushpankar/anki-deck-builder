...
var G__21339 = clojure.zip.node(loc);
var fexpr__21338 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__21338.cljs$core$IFn$_invoke$arity$1 ? fexpr__21338.cljs$core$IFn$_invoke$arity$1(G__21339) : fexpr__21338.call(null, G__21339));
});
/**
...
var G__21352 = clojure.zip.node(loc);
var fexpr__21350 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__21350.cljs$core$IFn$_invoke$arity$1 ? fexpr__21350.cljs$core$IFn$_invoke$arity$1(G__21352) : fexpr__21350.call(null, G__21352));
} else {
...
var fexpr__21359 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__21359.cljs$core$IFn$_invoke$arity$2 ? fexpr__21359.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__21359.call(null, node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__21376 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21376,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21376,(1),null);
var vec__21379 = clojure.zip.children(loc);
...
var vec__21396 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21396,(0),null);
var map__21399 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21396,(1),null);
var map__21399__$1 = cljs.core.__destructure_map(map__21399);
var path = map__21399__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21399__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21399__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21399__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21399__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21399__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__21424 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21424,(0),null);
var map__21427 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21424,(1),null);
var map__21427__$1 = cljs.core.__destructure_map(map__21427);
var path = map__21427__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21427__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__21428 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21427__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__21446 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21446,(0),null);
var map__21449 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21446,(1),null);
var map__21449__$1 = cljs.core.__destructure_map(map__21449);
var path = map__21449__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21449__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21449__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5000__auto__ = path;
if(cljs.core.truth_(and__5000__auto__)){
return r;
} else {
...
var vec__21459 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21459,(0),null);
var map__21462 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21459,(1),null);
var map__21462__$1 = cljs.core.__destructure_map(map__21462);
var path = map__21462__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21462__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21462__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5000__auto__ = path;
if(cljs.core.truth_(and__5000__auto__)){
...
var vec__21468 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21468,(0),null);
var map__21471 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21468,(1),null);
var map__21471__$1 = cljs.core.__destructure_map(map__21471);
var path = map__21471__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21471__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21471__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5000__auto__ = path;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__21474 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21474,(0),null);
var map__21477 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21474,(1),null);
var map__21477__$1 = cljs.core.__destructure_map(map__21477);
var path = map__21477__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21477__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__21492 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21492,(0),null);
var map__21495 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21492,(1),null);
var map__21495__$1 = cljs.core.__destructure_map(map__21495);
var path = map__21495__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21495__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__21503 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21503,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21503,(1),null);
...
var len__5726__auto___21668 = arguments.length;
var i__5727__auto___21669 = (0);
while(true){
if((i__5727__auto___21669 < len__5726__auto___21668)){
args__5732__auto__.push((arguments[i__5727__auto___21669]));

var G__21671 = (i__5727__auto___21669 + (1));
i__5727__auto___21669 = G__21671;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq21509){
var G__21510 = cljs.core.first(seq21509);
var seq21509__$1 = cljs.core.next(seq21509);
var G__21511 = cljs.core.first(seq21509__$1);
var seq21509__$2 = cljs.core.next(seq21509__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21510,G__21511,seq21509__$2);
}));
...
var G__21693 = clojure.zip.rightmost(child);
loc__$1 = G__21693;
continue;
} else {
return loc__$1;
...
var vec__21557 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21557,(0),null);
var map__21560 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21557,(1),null);
var map__21560__$1 = cljs.core.__destructure_map(map__21560);
var path = map__21560__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21560__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21560__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21560__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21560__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__21707 = clojure.zip.rightmost(child);
loc__$1 = G__21707;
continue;
} else {
return loc__$1;
