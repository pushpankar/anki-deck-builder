...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__22135){
var map__22136 = p__22135;
var map__22136__$1 = cljs.core.__destructure_map(map__22136);
var request = map__22136__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22136__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__22141 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22141.cljs$core$IFn$_invoke$arity$1 ? fexpr__22141.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22141.call(null, response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__22142 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22142.cljs$core$IFn$_invoke$arity$1 ? fexpr__22142.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22142.call(null, response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__22143){
var map__22144 = p__22143;
var map__22144__$1 = cljs.core.__destructure_map(map__22144);
var request = map__22144__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22144__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
