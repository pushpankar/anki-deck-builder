...
var zloc_seq_nc = (function (){var G__30781 = cljs.core.identity;
var G__30782 = new cljs.core.Keyword(null,"zloc","zloc",-2123059767).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__30780 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__30780.cljs$core$IFn$_invoke$arity$2 ? fexpr__30780.cljs$core$IFn$_invoke$arity$2(G__30781,G__30782) : fexpr__30780.call(null, G__30781,G__30782));
})();
var meta_zloc = cljs.core.second(zloc_seq_nc);
var meta_seq = (function (){var fexpr__30801 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__30801.cljs$core$IFn$_invoke$arity$2 ? fexpr__30801.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,meta_zloc) : fexpr__30801.call(null, cljs.core.identity,meta_zloc));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__30803 = cljs.core.second(meta_seq);
var fexpr__30802 = new cljs.core.Keyword(null,"ztag","ztag",125694964).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__30802.cljs$core$IFn$_invoke$arity$1 ? fexpr__30802.cljs$core$IFn$_invoke$arity$1(G__30803) : fexpr__30802.call(null, G__30803));
})())){
return null;
} else {
...
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__30881_SHARP_,p2__30880_SHARP_){
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__30880_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__30880_SHARP_));
} else {
return null;
}
}),null,rule_pairs);
...
var fn_str = cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_name);
var rule_pairs = cljs.core.partition.cljs$core$IFn$_invoke$arity$4((2),(2),cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(null),rules_vec);
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__31059_SHARP_,p2__31058_SHARP_){
var lhs = cljs.core.first(p2__31058_SHARP_);
...
return cljs.core.reduced(cljs.core.second(p2__31058_SHARP_));
} else {
return null;
}
} else {
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__31058_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__31058_SHARP_));
} else {
return null;
}
