...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__18882_SHARP_,p2__18881_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__18881_SHARP_) : pred.call(null, p2__18881_SHARP_)))){
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__18887_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__18887_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__18887_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__18888){
...
var children = (function (p1__18894_SHARP_){
if(cljs.core.coll_QMARK_(p1__18894_SHARP_)){
return cljs.core.seq(p1__18894_SHARP_);
} else {
return null;
}
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__18899_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__18899_SHARP_,cljs.core.contains_QMARK_(ks__$1,p1__18899_SHARP_)], null);
})),possible_ks);
});
