...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__33136_SHARP_){
return ((day8.re_frame_10x.tools.metamorphic.request_animation_frame_QMARK_(p1__33136_SHARP_)) || (day8.re_frame_10x.tools.metamorphic.request_animation_frame_end_QMARK_(p1__33136_SHARP_)));
}),traces);
})], 0));
...
var len__5726__auto___33192 = arguments.length;
var i__5727__auto___33193 = (0);
while(true){
if((i__5727__auto___33193 < len__5726__auto___33192)){
args_arr__5751__auto__.push((arguments[i__5727__auto___33193]));

var G__33194 = (i__5727__auto___33193 + (1));
i__5727__auto___33193 = G__33194;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$applyTo = (function (seq33142){
var G__33143 = cljs.core.first(seq33142);
var seq33142__$1 = cljs.core.next(seq33142);
var G__33144 = cljs.core.first(seq33142__$1);
var seq33142__$2 = cljs.core.next(seq33142__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33143,G__33144,seq33142__$2);
}));

(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$maxFixedArity = (2));

day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-time","day8.re-frame-10x.panels.timing.subs/animation-frame-time",1191520772),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-traces","day8.re-frame-10x.panels.timing.subs/animation-frame-traces",-1778771106)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.traces.subs","filtered-by-epoch-always","day8.re-frame-10x.panels.traces.subs/filtered-by-epoch-always",-1807060768)], null),(function (p__33163,p__33164){
var vec__33165 = p__33163;
var af_start_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33165,(0),null);
var epoch_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33165,(1),null);
var vec__33168 = p__33164;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33168,(0),null);
var frame_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33168,(1),null);
...
var vec__33175 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(frame_pairs,(frame_number - (1)));
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33175,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33175,(1),null);
...
var map__33182 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
var map__33182__$1 = cljs.core.__destructure_map(map__33182);
var event_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33182__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33182__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33182__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33182__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
