...
var args__$1 = args.map((function (p1__30534_SHARP_){
return sci.impl.types.eval(p1__30534_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__30560_SHARP_){
return sci.impl.types.eval(p1__30560_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__30571_SHARP_){
return sci.impl.types.eval(p1__30571_SHARP_,ctx,bindings);
})));
});
...
var or__5002__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"imports","imports",-1249933394).cljs$core$IFn$_invoke$arity$1(env),sym);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__30604 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30604,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30604,(1),null);
