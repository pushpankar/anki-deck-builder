...
return rewrite_clj.node.protocols.coerce((function (){var G__26681 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__26681) : f.call(null, G__26681));
})());
});
});
/**
...
var len__5726__auto___26738 = arguments.length;
var i__5727__auto___26739 = (0);
while(true){
if((i__5727__auto___26739 < len__5726__auto___26738)){
args__5732__auto__.push((arguments[i__5727__auto___26739]));

var G__26740 = (i__5727__auto___26739 + (1));
i__5727__auto___26739 = G__26740;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__26684_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__26684_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq26685){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26686,G__26687,seq26685__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null, e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__26710 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__26710) : str_fn.call(null, G__26710));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__26713 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__26713) : str_fn.call(null, G__26713));
})()):null)));
...
var G__26723 = rewrite_clj.zip.base.tag(zloc);
var G__26723__$1 = (((G__26723 instanceof cljs.core.Keyword))?G__26723.fqn:null);
switch (G__26723__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__26720_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__26720_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__26721_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__26721_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26723__$1)].join('')));
...
var G__26732 = rewrite_clj.zip.base.tag(zloc);
var G__26732__$1 = (((G__26732 instanceof cljs.core.Keyword))?G__26732.fqn:null);
switch (G__26732__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__26727_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__26727_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26732__$1)].join('')));
