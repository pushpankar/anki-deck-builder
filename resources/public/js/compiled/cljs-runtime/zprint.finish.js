...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__21375_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21375_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__21375_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__21388){
var vec__21390 = p__21388;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21390,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21390,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__21413,s,color,element,idx){
var map__21414 = p__21413;
var map__21414__$1 = cljs.core.__destructure_map(map__21414);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21414__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21414__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21414__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__21423 = (function (){var or__5002__auto__ = color;
...
var fexpr__21422 = (function (){var G__21431 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__21431) : style_map.call(null, G__21431));
})();
return (fexpr__21422.cljs$core$IFn$_invoke$arity$1 ? fexpr__21422.cljs$core$IFn$_invoke$arity$1(G__21423) : fexpr__21422.call(null, G__21423));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__21441){
var vec__21443 = p__21441;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21443,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21443,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21443,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__21455){
var vec__21456 = p__21455;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21456,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21456,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21456,(2),null);
...
var G__21935 = cljs.core.next(ssv);
var G__21936 = (this_ssv == null);
var G__21937 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__21938 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__21935;
doing_nil_QMARK_ = G__21936;
last_elide = G__21937;
out = G__21938;
continue;
}
...
var vec__21516 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21516,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21516,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21516,(2),null);
...
var G__21947 = cljs.core.next(remaining_cvec);
var G__21948 = new_idx;
var G__21949 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__21947;
idx = G__21948;
out = G__21949;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__21569,cursor_vec){
var vec__21570 = p__21569;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21570,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21570,(1),null);
var focus_vec = vec__21570;
...
var vec__21577 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21577,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21577,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(color_fn,p__21586){
var vec__21590 = p__21586;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21590,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21590,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__21646,existing_count){
var vec__21648 = p__21646;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21648,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21648,(1),null);
...
return cljs.core.filterv((function (p1__21628_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__21628_SHARP_))));
...
var vec__21726 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21726,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21726,(1),null);
var cvec_element = vec__21726;
if((cvec_element == null)){
var G__22105 = cljs.core.next(cvec_nl);
var G__22106 = (idx + (1));
var G__22107 = start;
var G__22108 = out;
cvec_nl = G__22105;
...
var G__22117 = cljs.core.next(cvec_nl);
var G__22118 = (idx + (1));
var G__22119 = idx;
var G__22120 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__22117;
idx = G__22118;
start = G__22119;
out = G__22120;
...
var G__22124 = cljs.core.next(cvec_nl);
var G__22125 = (idx + (1));
var G__22126 = (idx + (1));
var G__22127 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__22124;
idx = G__22125;
start = G__22126;
out = G__22127;
...
var G__22139 = cljs.core.next(cvec_nl);
var G__22140 = (idx + (1));
var G__22141 = idx;
...
var G__22144 = cljs.core.next(cvec_nl);
var G__22145 = (idx + (1));
var G__22146 = start;
var G__22147 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__22144;
idx = G__22145;
start = G__22146;
out = G__22147;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__21753_SHARP_,p2__21752_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__21752_SHARP_)){
return cljs.core.reduced(p1__21753_SHARP_);
} else {
return (p1__21753_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__21766,p__21767){
var vec__21773 = p__21766;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21773,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21773,(1),null);
var vec__21776 = p__21767;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21776,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21776,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__21837,cvec,focus_vec){
var map__21838 = p__21837;
var map__21838__$1 = cljs.core.__destructure_map(map__21838);
var options = map__21838__$1;
var map__21839 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21838__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__21839__$1 = cljs.core.__destructure_map(map__21839);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21839__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21839__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21839__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21828_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__21828_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
