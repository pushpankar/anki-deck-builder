...
var len__5726__auto___23409 = arguments.length;
var i__5727__auto___23410 = (0);
while(true){
if((i__5727__auto___23410 < len__5726__auto___23409)){
args__5732__auto__.push((arguments[i__5727__auto___23410]));

var G__23411 = (i__5727__auto___23410 + (1));
i__5727__auto___23410 = G__23411;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__23381){
var vec__23382 = p__23381;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23382,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__23372_SHARP_){
var and__5000__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__23372_SHARP_) : allowed_QMARK_.call(null, p1__23372_SHARP_)));
if(and__5000__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__23372_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq23374){
var G__23375 = cljs.core.first(seq23374);
var seq23374__$1 = cljs.core.next(seq23374);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23375,seq23374__$1);
}));
