...
var rewrite_clj$node$protocols$Node$tag$dyn_21792 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_21792(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_21802 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_21802(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_21817 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_21817(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_21826 = (function (node,opts){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_21826(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_21836 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_21836(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_21848 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_21848(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21483_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__21483_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_21883 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_21883(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_21892 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_21892(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_21900 = (function (node,children){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_21900(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_21905 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_21905(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_21930 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_21930(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_21934 = (function (node,map_qualifier){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_21934(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_21940 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_21940(node);
}
});
...
var map__21706 = cljs.core.meta(node);
var map__21706__$1 = cljs.core.__destructure_map(map__21706);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21706__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21706__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21706__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21706__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__21735,p__21736){
var vec__21737 = p__21735;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21737,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21737,(1),null);
var vec__21740 = p__21736;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21740,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21740,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__21745 = col_extent;
if((row_extent === (0))){
return (G__21745 + col);
} else {
return G__21745;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__21761 = rewrite_clj.node.protocols.children(node);
var G__21761__$1 = (((G__21761 == null))?null:cljs.core.first(G__21761));
if((G__21761__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__21761__$1);
}
} else {
