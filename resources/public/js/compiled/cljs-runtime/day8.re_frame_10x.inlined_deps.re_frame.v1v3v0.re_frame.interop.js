...
return [(function (){var pred__14694 = cljs.core.instance_QMARK_;
var expr__14695 = reactive_val;
if(cljs.core.truth_((pred__14694.cljs$core$IFn$_invoke$arity$2 ? pred__14694.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__14695) : pred__14694.call(null, day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__14695)))){
return "ra";
} else {
if(cljs.core.truth_((pred__14694.cljs$core$IFn$_invoke$arity$2 ? pred__14694.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__14695) : pred__14694.call(null, day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__14695)))){
return "rc";
} else {
if(cljs.core.truth_((pred__14694.cljs$core$IFn$_invoke$arity$2 ? pred__14694.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__14695) : pred__14694.call(null, day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__14695)))){
return "rx";
} else {
if(cljs.core.truth_((pred__14694.cljs$core$IFn$_invoke$arity$2 ? pred__14694.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__14695) : pred__14694.call(null, day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__14695)))){
return "tr";
} else {
return "other";
}
