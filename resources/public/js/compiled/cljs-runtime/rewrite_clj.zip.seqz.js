...
var G__27074 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null, zloc_n0));
var G__27074__$1 = (((G__27074 == null))?null:cljs.core.iterate((function (loc){
...
var G__27074__$2 = (((G__27074__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__27074__$1));
var G__27074__$3 = (((G__27074__$2 == null))?null:cljs.core.last(G__27074__$2));
if((G__27074__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__27074__$3);
}
} else {
return zloc;
}
...
var G__27143 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__27144 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__27143;
parent = G__27144;
continue;
} else {
var G__27145 = rewrite_clj.zip.move.right(zloc_map_value);
var G__27146 = parent;
loc = G__27145;
parent = G__27146;
continue;
...
var G__27154 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__27155 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__27154;
parent = G__27155;
continue;
} else {
var G__27158 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__27159 = parent;
loc = G__27158;
parent = G__27159;
continue;
...
var G__27116 = zloc;
var G__27116__$1 = (((G__27116 == null))?null:rewrite_clj.zip.move.down(G__27116));
var G__27116__$2 = (((G__27116__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__27116__$1,k));
if((G__27116__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__27116__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__27118 = zloc;
var G__27118__$1 = (((G__27118 == null))?null:rewrite_clj.zip.move.down(G__27118));
var G__27118__$2 = (((G__27118__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__27118__$1));
var G__27118__$3 = (((G__27118__$2 == null))?null:rewrite_clj.zip.move.down(G__27118__$2));
var G__27118__$4 = (((G__27118__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__27118__$3,k));
if((G__27118__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__27118__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__27124 = rewrite_clj.zip.move.down(zloc);
var G__27124__$1 = (((G__27124 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__27124));
if((G__27124__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__27124__$1);
}
})(),k);
