...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_40274 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_40274(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_40277 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_40277(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_40281 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_40281(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_40285 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_40285(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_40291 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_40291(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_40295 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_40295(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__40265,callback){
var map__40266 = p__40265;
var map__40266__$1 = cljs.core.__destructure_map(map__40266);
var input = map__40266__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40266__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40266__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
