...
var i_37920 = (self__.level + (1));
while(true){
if((i_37920 <= (new_level + (1)))){
(update[i_37920] = self__.header);

var G__37922 = (i_37920 + (1));
i_37920 = G__37922;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_37923 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37923[i]));
} else {
x__$2.forward.push((((i < links_37923.length))?(links_37923[i]):null));
}

if((i < links_37923.length)){
(links_37923[i] = x__$2);
} else {
links_37923.push(x__$2);
}
...
var i_37933 = (0);
while(true){
if((i_37933 <= self__.level)){
var links_37934 = (update[i_37933]).forward;
if((x__$1 === (((i_37933 < links_37934.length))?(links_37934[i_37933]):null))){
(links_37934[i_37933] = (x__$1.forward[i_37933]));

var G__37948 = (i_37933 + (1));
i_37933 = G__37948;
continue;
} else {
var G__37950 = (i_37933 + (1));
i_37933 = G__37950;
continue;
}
} else {
...
var G__37956 = nx;
var G__37957 = (level__$1 - (1));
x = G__37956;
level__$1 = G__37957;
continue;
} else {
var G__37958 = x;
var G__37959 = (level__$1 - (1));
x = G__37958;
level__$1 = G__37959;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__37970 = nx;
var G__37971 = (level__$1 - (1));
x = G__37970;
level__$1 = G__37971;
continue;
} else {
var G__37973 = x;
var G__37974 = (level__$1 - (1));
x = G__37973;
level__$1 = G__37974;
continue;
}
